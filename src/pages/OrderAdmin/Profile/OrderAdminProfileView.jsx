...
import profile from '../../../images/profile/profile-10.png'
          ...
          <div className="page-title-container">
            <div className="row g-0">
              ...
              <div className="col-auto d-flex align-items-end justify-content-end">
                <a href="/orderadmin-profileupdate">
                <button
                  type="button"
                  ...
                  <div className="card-body">
                    <form>
                      <div className="mb-3">
                        ...
                        <input type="text" className="form-control" value="James" readOnly/>
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <input type="tel" className="form-control" value="7685903452" readOnly/>
                      </div>
                      <div className="mb-3">
                        <label className="form-label">Email</label>
                        <input type="email" className="form-control" value="james@gmail.com" readOnly/>
                      </div>
                      <div className="mb-3">
                      ...
                      <div className="mb-3">
                        ...
                        <input type="text" className="form-control" value="James@123" readOnly/>
                      </div>
                    </form>
                  </div>
                </div>
