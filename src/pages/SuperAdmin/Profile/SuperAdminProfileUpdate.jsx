...
import Img from '../../../images/profile/profile-11.png'

function SuperAdminProfileUpdate() {
  return (
    <div>
      <main>
            ...
            <div className="row g-0">
              ...
              <div className="col-auto mb-3 mb-md-0 me-auto">
                <div className="w-auto sw-md-40">
                  <a href="/superadminprofile-view" className="muted-link pb-1 d-inline-block breadcrumb-back">
                ...
                <div className="card">
                  ...
                  <form>
                      <div className="mb-3">
                        ...
                        <input type="text" className="form-control" value="Robert William" />
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <input type="tel" className="form-control" value="8934568732" />
                      </div>
                      <div className="mb-3">
                        <label className="form-label">Email</label>
                        <input type="email" className="form-control" value="robert@gmail.com" />
                      </div>
                      <div className="mb-3">
                        <label className="form-label">Username</label>
                        <input type="text" className="form-control" value="robert"/>
                      </div>
                      <div className="mb-3">
                        <label className="form-label">Password</label>
                        <input type="text" className="form-control" value="robert@123"/>
                      </div>
                    </form>
                  </div>
                </div>
...
export default SuperAdminProfileUpdate
