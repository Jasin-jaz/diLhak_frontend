            ...
            <div className="row g-0">
              ...
              <div className="col-auto mb-3 mb-md-0 me-auto">
                <div className="w-auto sw-md-40">
                  ...
                  <h1 className="mb-0 pb-0 display-4" id="title">Order Admin View</h1>
                </div>
              </div>
              {/* <!-- Title End --> */}
              ...
              <div className="col-auto d-flex align-items-end justify-content-end">
                <a href={`/orderadmin-update/${user.id}`}>
                <button
                  type="button"
                ...
                <div className="card">
                  ...
                  <form>
                      ...
                      <div className="mb-3">
                        ...
                        <input type="text" className="form-control" value="Alice@123" readOnly/>
                      </div>
                    </form>
                  </div>
                </div>
                ...
                <div className="card">
                  <div className="card-body mb-n3">
                    ...
                    <div className="mb-3">
                      ...
                      <div>{user.user_registered_at}</div>
                    </div>
                    <div className="mb-3">
